const CACHE='wepadel-v3.16.3-no-api-cache';
const CORE=['./','index.html','styles.css?v=3.16.3','config.js?v=3.16.3','scoring.js?v=3.16.3','db.js?v=3.16.3','app.js?v=3.16.3','manifest.json','dashboard-padel-header-v3161.jpg','icons/wepadel-icon-192-v314.png','icons/wepadel-icon-512-v314.png','icons/wepadel-maskable-192-v314.png','icons/wepadel-maskable-512-v314.png','icons/wepadel-apple-touch-v314.png','logo-wepadel-transparent.png','logo-gjmotion-white.png','wepadel-avatar-sprite.png','icons/icon-192.png','icons/icon-512.png','icons/icon-maskable-192.png','icons/icon-maskable-512.png'];
