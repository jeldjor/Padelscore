const CACHE='padelscore-league-v2.0.0-online';
const CORE=['./','index.html','styles.css','config.js','scoring.js','db.js','app.js','manifest.json','icons/icon-192.png','icons/icon-512.png'];
