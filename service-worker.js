const CACHE='wepadel-v3.12.0-no-api-cache';
const CORE=['./','index.html','styles.css?v=3.12.0','config.js?v=3.12.0','scoring.js?v=3.12.0','db.js?v=3.12.0','app.js?v=3.12.0','manifest.json','logo-wepadel-transparent.png','logo-gjmotion-white.png','wepadel-avatar-sprite.png','icons/icon-192.png','icons/icon-512.png'];
