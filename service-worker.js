const CACHE='wepadel-v3.5.4-no-api-cache';
const CORE=['./','index.html','styles.css?v=3.5.4','config.js?v=3.5.4','scoring.js?v=3.5.4','db.js?v=3.5.4','app.js?v=3.5.4','manifest.json','logo-wepadel-transparent.png','logo-gjmotion-white.png','wepadel-avatar-sprite.png','icons/icon-192.png','icons/icon-512.png'];
